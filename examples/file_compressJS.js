/**
 * Compress a stream using Javascript only
 */
// Modules
...
var encoder = lz4.createEncoderStream({ useJS: true })
...
console.log('Compressing using Javascript %s to %s...', inputFile, outputFile)
